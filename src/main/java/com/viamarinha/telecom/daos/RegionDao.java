...
//              .findAny()
//              .orElse(null);
       // return jdbcTemplate.queryForObject("SELECT * FROM regions WHERE id=?", new Object[]{id}, new BeanPropertyRowMapper<>(Region.class));
        return jdbcTemplate.queryForObject("SELECT * FROM  regions WHERE id=?", new Object[]{id}, new RegionRowMapper());
    }
